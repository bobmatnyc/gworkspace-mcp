"""OAuth data models for Google Workspace authentication.
...
class OAuthToken(BaseModel):
    ...
    Represents the token response from Google OAuth with
...
class TokenMetadata(BaseModel):
    ...
    Attributes:
        service_name: Name of the service this token authenticates.
    ...
    provider: str = Field(default="google", description="OAuth provider identifier")
